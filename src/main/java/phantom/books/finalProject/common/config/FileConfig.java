...
public class FileConfig implements WebMvcConfigurer {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		registry.addResourceHandler(testResourceHandler).addResourceLocations(testResourceLocation);
		...
		registry.addResourceHandler("/images/bookCover/**").addResourceLocations("file:///C:/images/bookCover/");
